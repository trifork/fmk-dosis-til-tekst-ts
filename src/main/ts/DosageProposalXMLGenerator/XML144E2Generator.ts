...
export class XML144E2Generator extends AbstractXMLGenerator implements XMLGenerator {
    ...
    public generateXml(periods: DosagePeriod[], unitTextSingular: string, unitTextPlural: string, supplementaryText?: string): string {
        let dosageElement: string =
            ...
            "xmlns:m15e2=\"http://www.dkma.dk/medicinecard/xml.schema/2015/01/01/E2\" " +
        ...
        return dosageElement + "</m15:Structures></m15e2:Dosage>";
    }
