...
describe('version check', () => {
    it('should throw an exception for unsupported version', () => {
        expect(() => DosageProposalXMLGenerator.generateXMLSnippet('M+M+A+N', 1, '1+2+3+4', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", 10000)).to.throw("Unsupported dosageProposalXMLGeneratorVersion, only version 1 is supported");
    });
});
...
describe('generateXMLSnippet dosagetranslation values for M+M+A+N', () => {
    ...
    it('should handle M+M+A+N dose', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('M+M+A+N', 1, '1+2+3+4', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle Morning only', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('M+M+A+N', 1, '1', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle Noon only', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('M+M+A+N', 1, '0+1', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle Evening only', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('M+M+A+N', 1, '0+0+1', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle Night only', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('M+M+A+N', 1, '0+0+0+1', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
...
describe('generateXMLSnippet N daglig', () => {
    ...
    it('should handle 1', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('N daglig', 1, '1', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle 1;2', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('N daglig', 1, '1;2', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
        expect(snippet.getLongDosageTranslation()).to.equal("Doseringsforløbet starter fredag den 1. januar 2010, gentages hver dag, og ophører onsdag den 1. januar 2110:\n   Doseringsforløb:\n   1 tablet tages med rigeligt vand + 2 tabletter tages med rigeligt vand");
        expect(snippet.getShortDosageTranslation()).to.be.null;
    });

    it('should handle dag 1: 2 dag 2: 3 dose', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('N daglig', 1, 'dag 1: 2 dag 2: 3', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle dag 1: 2;3 dag 2: 4;5 dose', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('N daglig', 1, 'dag 1: 2;3 dag 2: 4;5', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
...
describe('generateXMLSnippet PN', () => {
    ...
    it('should handle 1', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('PN', 1, '1', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle 1.1;2.2', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('PN', 1, '1.1;2.2', 'ml', 'ml', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
        expect(snippet.getLongDosageTranslation()).to.equal("Doseringsforløbet starter fredag den 1. januar 2010, gentages hver dag, og ophører onsdag den 1. januar 2110:\n   Doseringsforløb:\n   1,1 ml efter behov tages med rigeligt vand + 2,2 ml efter behov tages med rigeligt vand");
        expect(snippet.getShortDosageTranslation()).to.be.null;
    });

    it('should handle dag 1: 2 dag 2: 3 dose', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('PN', 2, 'dag 1: 2 dag 3: 4', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle dag 1: 2 dag 2: 3 dose without iteration', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('PN', 0, 'dag 1: 2 dag 3: 4', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
    ...
    it('should handle dag 1: 2;3 dag 2: 4;5 dose', () => {
        let snippet = DosageProposalXMLGenerator.generateXMLSnippet('PN', 2, 'dag 1: 2;3 dag 2: 4;5', 'tablet', 'tabletter', 'tages med rigeligt vand', beginDate, endDate, "FMK146", dosageProposalXMLGeneratorVersion);
